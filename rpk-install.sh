...
usage() {
  this=$1
  cat <<EOF
$this: install rpk from github.com/redpanda-data/redpanda
...
Usage: $this [-b] bindir [-d] [tag]
 ...
 Generated by godownloader, and adapted by redpanda data
...
execute() {
  ...
  # Hash verify disabled, currently no checksums are published for rpk
